...
export function AppHeader({ title, subtitle, backTo }: AppHeaderProps) {
  ...
  return (
    <header className="rounded-2xl border border-white/10 bg-slate-900/50 p-5 backdrop-blur">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <p className="text-xs font-bold uppercase tracking-[0.18em] text-emerald-300">Smart Living Control</p>
